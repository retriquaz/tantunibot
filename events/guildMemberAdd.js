...
module.exports = (bot, member) => {
 ...
 if(genel){
 genel.send(`<@${member.user.id}> Hoşgeldin şu an onay sürecindesiniz. Onay alana kadar gerekli bilgileri okumanız tavsiye edilir.`+ member.guild.channels.find(channel => channel.name === "hoş-geldiniz").toString() + ` Bu kanaldan diğer onay bekleyenler ile sohbet edebilirsiniz. `);
 }
 if(sıra){
